...
import { View, Button, Link, Box, Stack, Input, useToast } from 'native-base';
  ...
  return (
    <Box style={styles.container}>
      ...
      <Box style={styles.centerInner}>
        ...
        <Box mt={8} style={styles.loginButtonSection}>
          <Button
      ...
      <Box style={styles.footerInner}>
        ...
        <Box style={styles.buttonContainer}>
          <TouchableOpacity onPress={() => navigation.navigate('Main', { screen: 'Register' })}>
